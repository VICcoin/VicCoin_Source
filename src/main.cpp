...
int64 nChainStartTime = 1468509022;
...
const string strMessageMagic = "VICCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    else if(nHeight > 100 && nHeight <= 2670000)
    {
        nSubsidy = 9 * COIN;
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in VICCoin
    bool fStrictPayToScriptHash = true; // Always active in VICCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "VICCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "fWorkL vector empty aagq fseek and ftell max VICCoin";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 556749 : 556749;
		...
		block.print();
		assert(block.hashMerkleRoot == uint256("0xb7a326e2c0244db8f1a36cc5f7f3a91eabc3f5bb008248352a2997975e4d6586"));
...
unsigned char pchMessageStart[4] = { 0xe8, 0xd2, 0xf4, 0xdf };
